...
namespace rc907613_mis4200.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "eventID,attendeeID,ticketID")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "eventID,attendeeID,ticketID")] Event @event)
        {
            if (ModelState.IsValid)
            {
